...
import com.marandu.testmon02.repository.OrigenEnergiaRepository;
...
/**
 * REST controller for managing {@link com.marandu.testmon02.domain.OrigenEnergia}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OrigenEnergiaResource {
    ...
    public OrigenEnergiaResource(OrigenEnergiaRepository origenEnergiaRepository) {
    ...
    public ResponseEntity<OrigenEnergia> createOrigenEnergia(@Valid @RequestBody OrigenEnergia origenEnergia) throws URISyntaxException {
        ...
        OrigenEnergia result = origenEnergiaRepository.save(origenEnergia);
    ...
    public ResponseEntity<OrigenEnergia> updateOrigenEnergia(@Valid @RequestBody OrigenEnergia origenEnergia) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, origenEnergia.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<OrigenEnergia> getOrigenEnergia(@PathVariable Long id) {
        ...
        Optional<OrigenEnergia> origenEnergia = origenEnergiaRepository.findById(id);
