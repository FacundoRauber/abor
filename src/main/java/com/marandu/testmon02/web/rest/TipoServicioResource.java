...
import com.marandu.testmon02.repository.TipoServicioRepository;
...
/**
 * REST controller for managing {@link com.marandu.testmon02.domain.TipoServicio}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TipoServicioResource {
    ...
    public TipoServicioResource(TipoServicioRepository tipoServicioRepository) {
    ...
    public ResponseEntity<TipoServicio> createTipoServicio(@Valid @RequestBody TipoServicio tipoServicio) throws URISyntaxException {
        ...
        TipoServicio result = tipoServicioRepository.save(tipoServicio);
    ...
    public ResponseEntity<TipoServicio> updateTipoServicio(@Valid @RequestBody TipoServicio tipoServicio) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tipoServicio.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TipoServicio> getTipoServicio(@PathVariable Long id) {
        ...
        Optional<TipoServicio> tipoServicio = tipoServicioRepository.findById(id);
