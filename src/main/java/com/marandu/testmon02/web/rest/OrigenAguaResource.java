...
import com.marandu.testmon02.repository.OrigenAguaRepository;
...
/**
 * REST controller for managing {@link com.marandu.testmon02.domain.OrigenAgua}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OrigenAguaResource {
    ...
    public OrigenAguaResource(OrigenAguaRepository origenAguaRepository) {
    ...
    public ResponseEntity<OrigenAgua> createOrigenAgua(@Valid @RequestBody OrigenAgua origenAgua) throws URISyntaxException {
        ...
        OrigenAgua result = origenAguaRepository.save(origenAgua);
    ...
    public ResponseEntity<OrigenAgua> updateOrigenAgua(@Valid @RequestBody OrigenAgua origenAgua) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, origenAgua.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<OrigenAgua> getOrigenAgua(@PathVariable Long id) {
        ...
        Optional<OrigenAgua> origenAgua = origenAguaRepository.findById(id);
