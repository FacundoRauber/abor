...
import com.marandu.testmon02.repository.TipoOcupacionRepository;
...
/**
 * REST controller for managing {@link com.marandu.testmon02.domain.TipoOcupacion}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TipoOcupacionResource {
    ...
    public TipoOcupacionResource(TipoOcupacionRepository tipoOcupacionRepository) {
    ...
    public ResponseEntity<TipoOcupacion> createTipoOcupacion(@Valid @RequestBody TipoOcupacion tipoOcupacion) throws URISyntaxException {
        ...
        TipoOcupacion result = tipoOcupacionRepository.save(tipoOcupacion);
    ...
    public ResponseEntity<TipoOcupacion> updateTipoOcupacion(@Valid @RequestBody TipoOcupacion tipoOcupacion) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tipoOcupacion.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TipoOcupacion> getTipoOcupacion(@PathVariable Long id) {
        ...
        Optional<TipoOcupacion> tipoOcupacion = tipoOcupacionRepository.findById(id);
