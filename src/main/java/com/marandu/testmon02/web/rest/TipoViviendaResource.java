...
import com.marandu.testmon02.repository.TipoViviendaRepository;
...
/**
 * REST controller for managing {@link com.marandu.testmon02.domain.TipoVivienda}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TipoViviendaResource {
    ...
    public TipoViviendaResource(TipoViviendaRepository tipoViviendaRepository) {
    ...
    public ResponseEntity<TipoVivienda> createTipoVivienda(@Valid @RequestBody TipoVivienda tipoVivienda) throws URISyntaxException {
        ...
        TipoVivienda result = tipoViviendaRepository.save(tipoVivienda);
    ...
    public ResponseEntity<TipoVivienda> updateTipoVivienda(@Valid @RequestBody TipoVivienda tipoVivienda) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tipoVivienda.getId().toString()))
            .body(result);
    }
