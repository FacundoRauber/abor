...
import com.marandu.testmon02.repository.TipoTratamientoBasuraRepository;
...
/**
 * REST controller for managing {@link com.marandu.testmon02.domain.TipoTratamientoBasura}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TipoTratamientoBasuraResource {
    ...
    public TipoTratamientoBasuraResource(TipoTratamientoBasuraRepository tipoTratamientoBasuraRepository) {
    ...
    public ResponseEntity<TipoTratamientoBasura> createTipoTratamientoBasura(@Valid @RequestBody TipoTratamientoBasura tipoTratamientoBasura) throws URISyntaxException {
        ...
        TipoTratamientoBasura result = tipoTratamientoBasuraRepository.save(tipoTratamientoBasura);
    ...
    public ResponseEntity<TipoTratamientoBasura> updateTipoTratamientoBasura(@Valid @RequestBody TipoTratamientoBasura tipoTratamientoBasura) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tipoTratamientoBasura.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TipoTratamientoBasura> getTipoTratamientoBasura(@PathVariable Long id) {
        ...
        Optional<TipoTratamientoBasura> tipoTratamientoBasura = tipoTratamientoBasuraRepository.findById(id);
