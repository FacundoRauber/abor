...
/**
 * REST controller for managing {@link com.marandu.testmon02.domain.Nacionalidad}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NacionalidadResource {
    ...
    public NacionalidadResource(NacionalidadRepository nacionalidadRepository) {
    ...
    public ResponseEntity<Nacionalidad> createNacionalidad(@RequestBody Nacionalidad nacionalidad) throws URISyntaxException {
        ...
        Nacionalidad result = nacionalidadRepository.save(nacionalidad);
    ...
    public ResponseEntity<Nacionalidad> updateNacionalidad(@RequestBody Nacionalidad nacionalidad) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, nacionalidad.getId().toString()))
            .body(result);
    }
