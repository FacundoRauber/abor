...
import com.marandu.testmon02.repository.NivelEducativoRepository;
...
/**
 * REST controller for managing {@link com.marandu.testmon02.domain.NivelEducativo}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NivelEducativoResource {
    ...
    public NivelEducativoResource(NivelEducativoRepository nivelEducativoRepository) {
    ...
    public ResponseEntity<NivelEducativo> createNivelEducativo(@Valid @RequestBody NivelEducativo nivelEducativo) throws URISyntaxException {
        ...
        NivelEducativo result = nivelEducativoRepository.save(nivelEducativo);
    ...
    public ResponseEntity<NivelEducativo> updateNivelEducativo(@Valid @RequestBody NivelEducativo nivelEducativo) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, nivelEducativo.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<NivelEducativo> getNivelEducativo(@PathVariable Long id) {
        ...
        Optional<NivelEducativo> nivelEducativo = nivelEducativoRepository.findById(id);
